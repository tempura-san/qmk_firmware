...
/* default Anne Pro layout, Windows style (with Umlauts) */
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT(
      ...
      KC_LCTL, KC_LWIN, KC_LALT,                   KC_SPACE,                                    KC_RALT, MO(FN),  LT(ANNE, KC_APP), KC_RCTL
  ),
  [FN] = LAYOUT(
      KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  XXXXXXX,
      XXXXXXX, XXXXXXX, KC_UP,   XXXXXXX, APL_RGB, APL_RAT, APL_BRT, APL_MOD, KC_UP,   KC_SCRL, KC_PAUS, KC_HOME, KC_END,  KC_PSCR,
      XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGUP, KC_PGDN,          XXXXXXX,
      _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TG(BT),  XXXXXXX, XXXXXXX, XXXXXXX, KC_INS,  KC_DEL,                    _______,
  ...
  [ANNE] = LAYOUT(
      ...
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, US_UDIA, XXXXXXX, US_ODIA, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
      XXXXXXX, US_ADIA, US_SS,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX,
      _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   _______,
      _______, _______, _______,                   XXXXXXX,                                     _______, _______, _______, _______
  ),
  [BT] = LAYOUT(
      TG(BT),  APB_HC1, APB_HC2, APB_HC3, APB_HC4, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, APB_LGC, APB_OFF, APB_ON,  XXXXXXX,
